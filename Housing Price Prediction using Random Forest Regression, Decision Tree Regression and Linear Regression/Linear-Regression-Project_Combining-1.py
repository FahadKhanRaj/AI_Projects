...
# # Raj's Part starts here: (temporary text)
# # ========================================
...
accuracyLM = lm.score(x_test, y_test) * 100
print("AccuracyLM:",accuracyLM)
#sns.pairplot(df)
...
percent_difference_lm = (abs(y_test - y_pred_lm)/y_test) * 100        # for Linear Regression
for i in range(len(percent_difference_lm)):
  if percent_difference_lm[i] <= 1:
    percent_difference_lm[i] = 1
  else:
    percent_difference_lm[i] = 0
# print(percent_difference_lm)

pScoreLM = average_precision_score(percent_difference_y, percent_difference_lm)
rScoreLM = recall_score(percent_difference_y, percent_difference_lm)

print("Precision Score for Linear Regression is:",pScoreLM)
print("Recall Score for Linear Regression is:",rScoreLM)
...
CM_lm = confusion_matrix(percent_difference_y, percent_difference_lm)       # for Linear Regression
print("Confusion Matrix for Linear Regression is:\n",CM_lm)
